...
******************************************************************************************************
   ...
   usage:
            ...
            Down2SLC_ASAR_Cat.py ProjectName DownName 
      
      e.g.  Down2SLC_ASAR_Cat.py CotopaxiT120ERSA 910101
...
def main(argv):
    ...
    te = 'te_' + Date
    call_str = "grep ASA_IMS_1P " + tt + " > " + te 
    os.system(call_str)
    ...
    for i in range(Na):
        ...
        call_str = 'ASAR_orb_cor_par.py ' + slcpar
        os.system(call_str)
