...
******************************************************************************************************
       ...
       SLC cat for time-series of SAR datasets.

   usage:
   
            down2slc_cat_all.py projectName
      
      e.g.  down2slc_cat_all.py PacayaERST163A
            down2slc_cat_all.py PacayaEnvT163A
...
def main(argv):
    ...
    if 'ERS' in projectName:
        call_str='Down2SLC_ERS_Cat_All.py ' + projectName
    else:
        call_str='Down2SLC_ASAR_Cat_All.py ' + projectName
